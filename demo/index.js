...
import FacebookLogin from '../src/facebook.hooks';
import FacebookLoginWithButton from '../src/facebook-with-button.hooks'
      ...
      <div>
        ...
        <div>
          ...
          <FacebookLoginWithButton
            ...
            autoLoad
            callback={responseFacebook => {console.log('responseFacebook', responseFacebook)}}
            icon="fa-facebook"
          />
        </div>
